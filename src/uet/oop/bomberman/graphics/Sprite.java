...
public class Sprite {
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite grass = new Sprite(DEFAULT_SIZE, 7, 15, SpriteSheet.tiles, 16, 16);
	public static Sprite brick = new Sprite(DEFAULT_SIZE, 4, 15, SpriteSheet.tiles, 16, 16);
	public static Sprite wall = new Sprite(DEFAULT_SIZE, 9, 15, SpriteSheet.tiles, 16, 16);
	public static Sprite portal = new Sprite(DEFAULT_SIZE, 13, 15, SpriteSheet.tiles, 14, 14);
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite player_up = new Sprite(DEFAULT_SIZE, 3, 14, SpriteSheet.tiles2, 12, 16);
	public static Sprite player_down = new Sprite(DEFAULT_SIZE, 0, 14, SpriteSheet.tiles2, 12, 15);
	public static Sprite player_right = new Sprite(DEFAULT_SIZE, 9, 14, SpriteSheet.tiles2, 10, 15);
	public static Sprite player_left = new Sprite(DEFAULT_SIZE, 6, 14, SpriteSheet.tiles2, 10, 16);
	
	public static Sprite player_up_1 = new Sprite(DEFAULT_SIZE, 4, 14, SpriteSheet.tiles2, 12, 16);
	public static Sprite player_up_2 = new Sprite(DEFAULT_SIZE, 5, 14, SpriteSheet.tiles2, 12, 15);
	
	public static Sprite player_down_1 = new Sprite(DEFAULT_SIZE, 1, 14, SpriteSheet.tiles2, 12, 15);
	public static Sprite player_down_2 = new Sprite(DEFAULT_SIZE, 2, 14, SpriteSheet.tiles2, 12, 16);
	
	public static Sprite player_right_1 = new Sprite(DEFAULT_SIZE, 10, 14, SpriteSheet.tiles2, 11, 16);
	public static Sprite player_right_2 = new Sprite(DEFAULT_SIZE, 11, 14, SpriteSheet.tiles2, 12 ,16);
	
	public static Sprite player_left_1 = new Sprite(DEFAULT_SIZE, 7, 14, SpriteSheet.tiles2, 11, 16);
	public static Sprite player_left_2 = new Sprite(DEFAULT_SIZE, 8, 14, SpriteSheet.tiles2, 12, 16);
